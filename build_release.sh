...
#	cp -r vidos_av1/S03Video_ram vidos_release/vidos_components
#	cp -r vidos_av1/S03Video_disk vidos_release/vidos_components
#	cp -r vidos_av1/S03Video_hybrid vidos_release/vidos_components

done
#for STYLE in "${SUPPORTED_STYLES[@]}"; do
#	cp -r vidos_av1/S03Video_$STYLE vidos_release/vidos_components
#done
